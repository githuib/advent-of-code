from based_utils.data.iterators import split_items, transpose_lines
from based_utils.data.strings import equalized_lines, split_at
...
class _Problem(MultiLineProblem[str]):
    ...
    def __init__(self) -> None:
        ...
        *rows, nums = (line[1::4] for line in stacks)
        cols = transpose_lines(equalized_lines(reversed(rows), max_length=len(nums)))
